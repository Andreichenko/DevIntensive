...
import com.softdesign.devintensive.ui.view.behaviors.AspectRatioImageView;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder> {
    ...
    public UsersAdapter(List<UserListRes.UserData> users, UserViewHolder.CustomClickListener customClickListener) {
                ...
                Picasso.with(mContext)
                        ...
                        .placeholder(mContext.getResources().getDrawable(R.drawable.user_foto))
                        .error(mContext.getResources().getDrawable(R.drawable.user_foto))
