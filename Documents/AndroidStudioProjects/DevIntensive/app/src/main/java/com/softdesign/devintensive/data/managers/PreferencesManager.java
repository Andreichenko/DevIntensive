...
public class    PreferencesManager {
    ...
    public List<String> loadUserProfileValues() {
        ...
        userValues.add(mSharedPreferences.getString(ConstantManager.USER_RATING_VALUE, "18"));
        userValues.add(mSharedPreferences.getString(ConstantManager.USER_CODE_LINES_VALUE, "3274"));
        userValues.add(mSharedPreferences.getString(ConstantManager.USER_PROJECT_VALUE, "1"));
