...
/**
 * Created by AlexFrei on 22.06.16.
 */
public interface ConstantManager {
    ...
    String USER_AVATAR_KEY = "AVATAR_KEY";
    String USER_ID_KEY = "USER_ID_KEY";
    String AUTH_TOKEN = "AUTH_TOKEN";
    String USER_RATING_VALUE = "USER_RATING";
    String USER_COUNT_PROJECTS_VALUE = "USER_COUNT_PROJECTS";
    String USER_CODE_LINES_VALUE = "USER_CODE_LINES";


    int LOAD_PROFILE_FOTO = 1;
    int REQUEST_CAMERA_PICTURE = 87;
    int REQUEST_GALLERY_PICTURE = 88;

    int PERMISSION_REQUEST_SETTINGS_CODE = 101;
    int CAMERA_REQUEST_PERMISSION_CODE = 102 ;
    int PERMISSION_CALL_REQUEST_CODE = 103;
}
